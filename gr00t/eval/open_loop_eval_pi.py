# # source /pi/Isaac-GR00T/gr00t/eval/sim/robocasa/robocasa_uv/.venv/
# import argparse
# import logging
...
# # ================= 配置区域 =================
# # 对应你的 tree 结构
# BASE_DIR = "/pi/open_loop_data"
# DEFAULT_PARQUET = f"{BASE_DIR}/episode_000000.parquet"
# DEFAULT_VIDEO_WRIST = f"{BASE_DIR}/wrist/episode_000000.mp4"
...
#     fig.suptitle(f"Open Loop Replay (Dims 5-12): GT (Blue) vs Pred (Red)", fontsize=16)
...
#         if len(imgs) != 3: break # 确保每一帧都读到了3个视角
